...
Focus: Auth, authorization, secrets in code or logs, injection, permissions, data exposure. Special attention: the deletion path under the user global ~/.claude/skills (bee-* fence, symlink handling, path containment, TOCTOU), and whether tests can ever touch the real home dir.
