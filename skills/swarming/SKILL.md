...
name: swarming
description: >-
  Use when validating approves execution. Orchestrates bounded workers,
  reservations, worker results, rescues, and phase handoff. Tends the swarm
  but never implements cells directly.
metadata:
  version: '0.1'
  ecosystem: bee
  dependencies:
