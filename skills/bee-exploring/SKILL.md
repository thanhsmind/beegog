...
6. **State And Handoff**
   - Update state:
     ```
     node .bee/bin/bee.mjs state set --phase exploring --feature "<feature>" --summary "Exploring complete. CONTEXT.md is ready for planning." --next-action "Gate 1, then invoke bee-planning."
     ```
