...
name: grooming
description: >-
  Use when the user asks to clean up, hunt tech debt, audit hive health, or when
  reviewing/compounding has filed backlog items worth killing. Also for periodic
  entropy audits.
metadata:
  version: '0.1'
  ecosystem: bee
