...
name: validating
description: >-
  Use when planning has an approved work shape that needs feasibility
  validation before swarming. Rejects plans built on plausibility instead of
  evidence; runs the reality gate, feasibility matrix, spikes, adversarial
  plan-checking, and cold-pickup cell review before Gate 3.
metadata:
  version: '0.1'
  ecosystem: bee
  dependencies:
