...
On approval, update state: `node .bee/bin/bee_state.mjs gate --name execution --approved true` then `node .bee/bin/bee_state.mjs set --phase validated --summary "<summary>" --next-action "Invoke bee-swarming for the validated work."`
