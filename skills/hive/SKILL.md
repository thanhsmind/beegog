...
name: hive
description: >-
  Use when starting or resuming any bee session, choosing the next bee skill,
  running go mode, checking onboarding state, or enforcing workflow gates.
  Bootstrap meta-skill for routing across the bee ecosystem.
metadata:
  version: '0.1'
  ecosystem: bee
  dependencies:
...
| Improve bee itself | `bee:writing-bee-skills` |
