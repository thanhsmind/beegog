---
name: writing-bee-skills
description: >-
  Use when creating a new bee skill, editing an existing bee skill, or verifying
  a skill works under pressure before deploying. Do NOT use for project-specific
  AGENTS.md conventions or one-off instructions.
metadata:
  version: '0.1'
  ecosystem: bee
  dependencies: []
...
- [ ] `name`: bare hyphen-case, matches the directory name exactly (the plugin adds the `bee:` prefix)
- [ ] `description`: starts with "Use when..." — **triggering conditions ONLY, no workflow summary**; third person, ≤1024 chars
