...
- **Description trigger:** "Use when the final swarm slice completes. Runs specialist review, artifact verification, UAT, review cells, finishing checks, and handoff to scribing."
- **Dependencies:** none.
