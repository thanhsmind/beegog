...
## [20260721] Race tests assert structure, never scheduler luck — and a race harness that hides the child's stderr is itself a bug
**Category:** tests
**Feature:** release-1-7-10-rc
**Tags:** [ci, concurrency, determinism, windows, 2-core]
