...
**Reject:**
- 14 agents + 40 skills + a 16-hook sprawl with overlapping concerns (bee: 11 decision-gated skills, exactly 6 hooks wrapping shared `lib/` modules), env-var context injection (bee puts subagent context inline in the spawn prompt), multi-kit distribution, configurable naming DSL.
