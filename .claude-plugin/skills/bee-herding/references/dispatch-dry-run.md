...
(`/home/you/proj/repo--wt--agent-pane-orchestration`), following
`.claude/skills/bee-herding/SKILL.md` section by section. One honest deviation is
...
```
docs/history/<upstream-feature>/CONTEXT.md:8:**Backlog:** PBI-043
```
